...
export type MyKeyboardHandler<P = PluginOptions> = KeyboardHandler<P,
    MyValue,
    MyEditor>;
...
export type MyPlatePlugin<P = PluginOptions> = PlatePlugin<P,
    MyValue,
    MyEditor>;
...
export type MyWithOverride<P = PluginOptions> = WithOverride<P,
    MyValue,
    MyEditor>;
